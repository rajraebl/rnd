...
using System.Linq;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RU4.DAL.RU4Context>
    {
        ...
        protected override void Seed(RU4.DAL.RU4Context context)
        {
        ...
        void AddOrUpdateInstructor(RU4.DAL.RU4Context context, string courseTitle, string instructorName)
        {
